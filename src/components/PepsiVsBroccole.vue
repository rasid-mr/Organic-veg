  ...
  <div class="pot">
    ...
    <div class="vs">
      <div class="vs_broccole">
        <svg width="690" height="480" viewBox="-155 0 690 480" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="vs_pepsi">
        <svg width="690" height="480" viewBox="0 0 690 480" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <image x="20em" y="100%" class="vs_pepsi-calory"  xlink:href="../assets/coca-cola.jpg" ></image>
        </svg>
...
onMounted(() => {
  ...
  function sceneCardBroccole() {
  const card = gsap.timeline()
  card.set('.vs_broccole-calory', {attr: {y:"100%" }})
  card.to('.vs_broccole-calory', {attr: {y: "67%"}, duration:2, delay:3})
  // card.to('.vs_pepsi-calory', {attr: { y:"67%"}, duration:2 }, "-=2")
  }
  function sceneCardPepsi() {
  const card = gsap.timeline()
  card.set('.vs_pepsi-calory', {attr:{y:"100%"}})
  card.to('.vs_pepsi-calory', {attr: { y:"67%"}, duration:2, delay:3})
  }
  ...
  function scenePepsi() {
    ...
    tl.to(pepsi, {strokeDashoffset:0, duration:3, ease:"power3.inOut"})
...
.vs {
    ...
    align-items: flex-end;
      margin-block-start: var(--size-fluid-9);
...
.explain {
  ...
  // margin-inline-start: var(--size-fluid-6);
